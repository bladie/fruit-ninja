...
def how_to():
    ...
    while True:
        ...
        text = '                        Welcome to Fruit Warrior\n' \
               ...
               'Level 1 is the game with bombs thrown at you along with   some limited lives(3).\n' \
               'Level 2 is the game with a fixed time of 60 seconds and no bombs or obstacle thrown at you'
...
def levels():
    ...
    while True:
        ...
        text7 = font7.render('BOMB MODE', True, black)
